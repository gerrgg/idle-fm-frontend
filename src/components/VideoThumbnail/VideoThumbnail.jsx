import { Thumbnail, PlaceholderImage } from "./VideoThumbnail.styles.jsx";

export default function VideoThumbnail({ image, variant }) {
  if (image === null) {
    return (
  ...
  return <Thumbnail src={image} variant={variant} />;
}
